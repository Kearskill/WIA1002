...
//        System.out.println();
//
//        System.out.println("In and out degree for Kuching is "  + graph1.getIndex("Kuching") + " and  " + graph1.outDeg("Kuching"));
//        System.out.println("In and out degree for Penang is "  + graph1.getIndex("Penang") + " and  " + graph1.outDeg("Penang"));
//        System.out.println("In and out degree for Ipoh is "  + graph1.getIndex("Ipoh") + " and  " + graph1.outDeg("Ipoh"));
//        System.out.println();
//
